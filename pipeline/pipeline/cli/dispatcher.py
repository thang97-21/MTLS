...
PHASE_NAMES = {
    ...
    'phase1.15': 'Phase 1.15 - Title Philosophy Injection',
    'phase1.5': 'Phase 1.5 - Schema Autoupdate + Metadata Translation',
    'phase1.51': 'Phase 1.51 - Koji Fox Voice RAG Expansion',
    'phase1.52': 'Phase 1.52 - EPS Band Backfill',
    'phase1.55': 'Phase 1.55 - Full-LN Cache Rich Metadata Enrichment',
    'phase1.56': "Phase 1.56 - Translator's Guidance Brief (Batch Pre-Analysis)",
    ...
    'batch': 'Batch Pipeline (1.5 → 1.55 → 1.56 → 1.6 → 1.7 → 2)',
    'multimodal': 'Multimodal Translator (Phase 1.6 + Phase 2 with Visual Context)',
    'phase2': 'Phase 2 - Translator',
    'phase2.5': 'Phase 2.5 - Volume Bible Update',
    'fix-name-order': 'Name-Order Normalizer',
